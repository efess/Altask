    ...
    init() {
        ...
        this.assetTab = {
			...
			filterC: {
				...
				data: [{ id: 1, label: "All" }, { id: 2, label: "Past Due" }, { id: 3, label: "Due Today" }, { id: 4, label: "Complete" }, { id: 5, label: "In Progress" }],
				events: {
					onSelectionChanged: () => {
            ...
            this.settings.tabs.forEach((tab) => {
                ...
                if (tab.type === "user") {
					...
					if (this.assetTab.filterC.model.length > 0) {
						if (!statusMatches(this.assetTab.filterC.model[0], this.task)) {
							show = false;
						}
					}
                }
