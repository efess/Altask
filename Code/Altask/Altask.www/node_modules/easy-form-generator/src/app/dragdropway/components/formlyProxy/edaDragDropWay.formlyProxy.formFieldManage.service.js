...
class formFieldManage{
  ...
  constructor(EasyFormGenFormlyProxyModels) {
  ...
  initConfigurationEditFromScratch(configurationModel, addStepWayProperties) {
    let configurationModelInit = this.EasyFormGenFormlyProxyModels.getEasyFormInitialStateConfigurationModel(addStepWayProperties);
  ...
  bindConfigurationLines(configurationModel, lines, addStepWayProperties){
    if( Object.prototype.toString.call(lines) === '[object Array]' ) {
      let configurationModelResult = this.EasyFormGenFormlyProxyModels.getEasyFormReloadConfigurationModel(addStepWayProperties);
    ...
    configurationModel.lines[lineIndex].columns.forEach( (column) => {
      ...
      if (typeof controlTemplate  !== 'undefined' &&
        ...
        if(column.control.type  === 'header' ||
          ...
          controlTemplate.template  = this.EasyFormGenFormlyProxyModels.getHeaderTemplateForNcolumnLine(numberOfColumns, headerTextContent).template;
          controlTemplate.className = this.EasyFormGenFormlyProxyModels.getRawHeaderTemplates().selectedClass;
        } else {
          controlTemplate = this.EasyFormGenFormlyProxyModels.getFormlyControlTemplateForNcolumnLine(numberOfColumns, column.control.type);
          /**
          * NEED REFACTOR HERE
