...
class ddModelConfModelProxyService{
  ...
  refreshAllConfigurationFromDragAndDropModel(configModel, ddModel){
    ...
    angular.forEach(ddModel[1], (lineValue, keyValue)=>{
      ...
      configModel.lines.push(angular.copy(this.EasyFormGenFormlyProxyModels.getEasyFormEmptyConfigurationLineModel()));
      ...
      angular.forEach(lineValue, (colValue, colIndex)=>{
        ...
        let controlToBind = {
          control : angular.copy(this.EasyFormGenFormlyProxyModels.getFormlyControlTemplateForNcolumnLine(lineValue.length, this.getFormlyDetailedControlModelFromDragDropObject(lineValue[colIndex]).formlyType))
        };
        ...
        if(typeof colValue.key !== 'undefined'){
          ...
          var newClassName = this.EasyFormGenFormlyProxyModels.getFormlyControlTemplateForNcolumnLine(lineValue.length, this.getFormlyDetailedControlModelFromDragDropObject(lineValue[colIndex]).formlyType);
          ...
          if (typeof configModel.lines[keyValue].columns[colIndex] === 'undefined') configModel.lines[keyValue].columns.push(angular.copy(this.EasyFormGenFormlyProxyModels.getEasyFormConfigurationEmptyControlModel())); 
  ...
  getFormlyDetailedControlModelFromDragDropObject(dragDrapCtrlModel){
    let controlModel        = {};
    let listControl         = this.EasyFormGenFormlyProxyModels.getEasyFormListControls();
