@import "drag_and_drop_var";
@import "drag_and_drop_mixins";
@import "eda.textAngular.min";
...
/*container to 100%*/
@include media-bureau-min-width {
  .container
  {
...
@include media-smartphone-min-width {
  .container
  {
    width: $container-width;
    margin-right:20px;
...
@include media-tablette-min-width {
  .container
  {
    width: $container-width;
...
.panel-default>.panel-heading {
  color: $panel-defaut-panel-heading-text-color;
  background-color: $panel-defaut-panel-heading-background-color;
  border-color: $panel-defaut-panel-heading-border-color;
}
.navbar-nav>li>a {
  line-height: 30px;
}
...
.panel-heading{
  ...
  border-bottom: solid 1px $panel-defaut-panel-heading-border-color;//#CCC;
}
...
#pageWfEdit{
 ...
 /*    right:2%;
  ...
  background-color: $background-color-grey;//#FFF;//$ebony-clay-color;
...
.animate-switch-container {
  ...
  background:white;
  border:{
      top:solid 1px $white-smoke-color;
      bottom:solid 1px $white-smoke-color;
    }//1px solid black;
  ///height:750px;//100%;
  overflow:scroll;
   .well{
      background-color:$jordy-color;
      margin:{
        bottom:0px;
      }
...
// textAngular div to apply a margin bottom
.ta-scroll-window
{
  margin-bottom:16px;
}
//checkbox Y-placement correction
 ...
 */
.easy-form-builder ul[dnd-list],
.easy-form-builder ul[dnd-list] > li {
  position: relative;
 ...
 */
.easy-form-builder .dropzone ul[dnd-list] {
    min-height: 42px;
    margin: 0px;
    padding-left: 0px;
 ...
 */
.easy-form-builder .dropzone .dndDragging {
    opacity: 0.7;
 ...
 */
.easy-form-builder .dropzone .dndDraggingSource {
    display: none;
}
 ...
 */
.easy-form-builder .dropzone .dndPlaceholder {
...
.easy-form-builder .dropzone .itemlist {
...
.easy-form-builder .dropzone .itemlist > li {
     //background-color: #0d87e9;
     border: none;
     //width: 75px;
     min-width: 180px;
    ...
    // text-align: center;
    // // width: 180px;
    // @extend .effect1ForDragDropItem;
}

#itemContent{
    background-color: #fff;//#0d87e9;
...
.easy-form-builder .dropzone .container-element {
    margin: 10px;
}
...
.confirmLineDelete{
    ...
    background-color: #F5F5F5;//#ECF0F1;
    opacity: 1.0;
...
.vertical-line{
   border-left: thick solid #000; //#ff0000;
}
