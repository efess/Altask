...
class controllerModalProxy{
  ...
  resetNyaSelect(nyaSelectObj){
    let newNyaSelectObj = this.EasyFormGenFormlyProxyModels.getEasyFormListControls();
  ...
  resetProxyModel(){
    let newProxyModel = this.EasyFormGenFormlyProxyModels.getEasyFormListControls();
