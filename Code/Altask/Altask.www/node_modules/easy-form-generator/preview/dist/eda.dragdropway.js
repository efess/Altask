...
/***/ function(module, exports) {
	...
	function formlyConfig(formlyConfigProvider, EasyFormGenFormlyProxyModelsProvider, easyFormDragWayConfigProvider) {
	  ...
	  EasyFormGenFormlyProxyModelsProvider.addEasyFormControlToList({
	    id: 'empty',
	    name: 'no control',
	    subtitle: 'no control',
	    group: 'Blank',
	   ...
	   *
	    ...
	    *
	    * just declare in EasyFormGenFormlyProxyModelsProvider
	    */
	  EasyFormGenFormlyProxyModelsProvider.addEasyFormControlToList({
	    id: 'Password',
	    name: 'Password',
	...
	formlyConfig.$inject = ['formlyConfigProvider', 'EasyFormGenFormlyProxyModelsProvider', 'easyFormDragWayConfigProvider'];
...
/***/ function(module, exports) {
	...
	var controllerModalProxy = function () {
	  function controllerModalProxy(EasyFormGenFormlyProxyModels) {
	    _classCallCheck(this, controllerModalProxy);
	
	    this.EasyFormGenFormlyProxyModels = EasyFormGenFormlyProxyModels;
	    this.init();
	  }
	  ...
	  _createClass(controllerModalProxy, [{
	    ...
	    value: function resetNyaSelect(nyaSelectObj) {
	      var newNyaSelectObj = this.EasyFormGenFormlyProxyModels.getEasyFormListControls();
	    ...
	    value: function resetProxyModel() {
	      var newProxyModel = this.EasyFormGenFormlyProxyModels.getEasyFormListControls();
	    ...
	    value: function getSelectedProxyModel(configurationSelectedCtrl) {
	      ...
	      var listProxyModelCTRL = angular.copy(this.EasyFormGenFormlyProxyModels.getEasyFormListControls().controls);
	...
	controllerModalProxy.$inject = ['EasyFormGenFormlyProxyModels'];
...
/***/ function(module, exports) {
	...
	var formFieldManage = function () {
	  function formFieldManage(EasyFormGenFormlyProxyModels) {
	  ...
	  _createClass(formFieldManage, [{
	    ...
	    value: function initConfigurationEditFromScratch(configurationModel, addStepWayProperties) {
	      var configurationModelInit = this.EasyFormGenFormlyProxyModels.getEasyFormInitialStateConfigurationModel(addStepWayProperties);
	    ...
	    value: function bindConfigurationLines(configurationModel, lines, addStepWayProperties) {
	      if (Object.prototype.toString.call(lines) === '[object Array]') {
	        var configurationModelResult = this.EasyFormGenFormlyProxyModels.getEasyFormReloadConfigurationModel(addStepWayProperties);
	      ...
	      configurationModel.lines[lineIndex].columns.forEach(function (column) {
	        ...
	        column.control.type !== 'none') {
	          ...
	          if (column.control.type === 'header' || column.control.type === 'subTitle') {
	            ...
	            controlTemplate.template = _this.EasyFormGenFormlyProxyModels.getHeaderTemplateForNcolumnLine(numberOfColumns, headerTextContent).template;
	            controlTemplate.className = _this.EasyFormGenFormlyProxyModels.getRawHeaderTemplates().selectedClass;
	          } else {
	            controlTemplate = _this.EasyFormGenFormlyProxyModels.getFormlyControlTemplateForNcolumnLine(numberOfColumns, column.control.type);
	            /**
	            * NEED REFACTOR HERE
	...
	formFieldManage.$inject = ['EasyFormGenFormlyProxyModels'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.EASY_FORM_FORMLY_PROXY_MODELS = undefined;
	...
	var EASY_FORM_FORMLY_PROXY_MODELS = 'EasyFormGenFormlyProxyModels';
	
	function EasyFormGenFormlyProxyModels() {
	...
	EasyFormGenFormlyProxyModels.$inject = [];
	
	exports.default = EasyFormGenFormlyProxyModels;
	exports.EASY_FORM_FORMLY_PROXY_MODELS = EASY_FORM_FORMLY_PROXY_MODELS;
...
/***/ function(module, exports) {
	...
	var ddModelConfModelProxyService = function () {
	  function ddModelConfModelProxyService(EasyFormGenFormlyProxyModels,
	  ...
	  _createClass(ddModelConfModelProxyService, [{
	    ...
	    value: function refreshAllConfigurationFromDragAndDropModel(configModel, ddModel) {
	      ...
	      angular.forEach(ddModel[1], function (lineValue, keyValue) {
	        ...
	        configModel.lines.push(angular.copy(_this.EasyFormGenFormlyProxyModels.getEasyFormEmptyConfigurationLineModel()));
	        ...
	        angular.forEach(lineValue, function (colValue, colIndex) {
	          ...
	          var controlToBind = {
	            control: angular.copy(_this.EasyFormGenFormlyProxyModels.getFormlyControlTemplateForNcolumnLine(lineValue.length, _this.getFormlyDetailedControlModelFromDragDropObject(lineValue[colIndex]).formlyType))
	          };
	          ...
	          if (typeof colValue.key !== 'undefined') {
	            ...
	            var newClassName = _this.EasyFormGenFormlyProxyModels.getFormlyControlTemplateForNcolumnLine(lineValue.length, _this.getFormlyDetailedControlModelFromDragDropObject(lineValue[colIndex]).formlyType);
	          ...
	          if (typeof configModel.lines[keyValue].columns[colIndex] === 'undefined') configModel.lines[keyValue].columns.push(angular.copy(_this.EasyFormGenFormlyProxyModels.getEasyFormConfigurationEmptyControlModel()));
	     ...
	     * (more formly detailed : see controls property in EasyFormGenFormlyProxyModels._easyFormListControls)
	     */
	    ...
	    value: function getFormlyDetailedControlModelFromDragDropObject(dragDrapCtrlModel) {
	      var controlModel = {};
	      var listControl = this.EasyFormGenFormlyProxyModels.getEasyFormListControls();
	...
	ddModelConfModelProxyService.$inject = ['EasyFormGenFormlyProxyModels',
	// 'controllerModalProxy',
	// 'dragDropConfig',
	'easyFormDragWayConfig', '$parse'];
