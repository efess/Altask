/* global angular */
import * as helpers from './leftPanel.selectOptionManage.service.helpers';
...
class selectOptionMange {
    ...
    initModel(selectObj) {
        helpers.resetOptions(selectObj);
    }
    ...
    addNewOptionRadio(selectObj, newOptionText) {
        ...
        let checkResult = helpers.validateOption(selectObj, newOptionText);
