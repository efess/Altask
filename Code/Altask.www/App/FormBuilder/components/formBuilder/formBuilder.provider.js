...
} from './formBuilder.provider.helpers';

const FORM_BUILDER_CONFIG_PROVIDER = 'FormBuilderConfig';

function FormBuilderConfig() {
    ...
    this.$get = formBuilderConfigGet;
    this.setModalAnimation = setModalAnimation;
    this.getModalAnimation = getModalAnimation;
    this.formBuilderModel = _configuration;
    ...
    function addControl(controlToAdd, groupToAdd) {
    ...
    //$get implementation:
    // formBuilderConfigGet.$inject = ['$translate'];
    // function formBuilderConfigGet($translate){
    formBuilderConfigGet.$inject = [];

    function formBuilderConfigGet() {
        ...
        let service = {
            ...
            cssClassFromColumns: cssClassFromColumns,
        ...
        function cssClassFromColumns(numberOfItems) {
    ...
    function addToGroupControl(thisControl, thisGroup) {
        ...
        if (_dragDropPresentationModel[0].length > 0) {
            ...
            _dragDropConfigModel.containerConfig.decoration.forEach((groupConfig) => {
                if (thisGroup.addToGroupController === groupConfig.groupId) {
...
// FormBuilderConfig.$inject = ['$translateProvider'];

FormBuilderConfig.$inject = [];
